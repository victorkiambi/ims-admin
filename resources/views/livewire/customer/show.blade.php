    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-start mb-6">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ url('customers/'.$customer->id.'/edit') }}" class="inline-flex items-center gap-x-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500">
                        ...
                        @forelse($orders as $order)
                            ...
                            <span @class([
                                ...
                                <td class="whitespace-nowrap px-3 py-2 text-right text-sm">
                                    <a href="{{ url('orders/'.$order->id) }}" class="text-blue-600 hover:text-blue-900">View</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
