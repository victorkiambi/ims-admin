                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-4">
                                <a href="{{ url('customers/'.$customer->id) }}" class="text-blue-600 hover:text-blue-900 flex items-center gap-1">
                                ...
                                <a href="{{ url('customers/'.$customer->id.'/edit') }}" class="text-blue-600 hover:text-blue-900 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
