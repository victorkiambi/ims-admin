            ...
            @forelse($orders as $order)
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 flex items-center gap-4">
                        <a href="{{ url('orders/'.$order->id) }}" class="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline flex items-center gap-1">
                        ...
                        <a href="{{ url('orders/'.$order->id.'/edit') }}" class="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
